                ...
                <section className="row justify-content-center align-items-center">
                    <form onSubmit={handleSubmit(this.onSubmit)} className='col-8 form shadow p-3 mb-5 bg-white rounded materializecss'>
                        ...
                        <div className='w-100 justify-content-end row'>
                            {/*<InputForm.Button label='Cadastrar' type='submit' color='bg-primary' isLoading={formReducer.isLoading} icon=''/>*/}
                            <LoadingButton isLoading={formReducer.isLoading} label='Cadastrar' type='submit' color='bg-primary' icon='send' className='material-icons right' />
                            <InputForm.Button label='Cancelar' type='button' color='bg-secondary' onClick={this.init} icon=''/>
                        </div>
                    </form>
                </section>
            </React.Fragment>
